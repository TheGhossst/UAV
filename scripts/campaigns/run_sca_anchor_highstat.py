...
Usage:
  python scripts/campaigns/run_sca_anchor_highstat.py --n-runs 100 --area-m 100 --axis iots
  python scripts/campaigns/run_sca_anchor_highstat.py --n-runs 200 --area-m 500 --axis all
"""
