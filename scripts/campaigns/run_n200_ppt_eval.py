...
Usage:
  python scripts/campaigns/run_n200_ppt_eval.py
  python scripts/campaigns/run_n200_ppt_eval.py --only 100m
  python scripts/campaigns/run_n200_ppt_eval.py --only 500m --skip-td3
  python scripts/campaigns/run_n200_ppt_eval.py --plot-only
"""
