...
Usage:
  ...
  python scripts/campaigns/run_sca_multistart_eval.py --n-runs 2 --seed-start 1
  python scripts/campaigns/run_sca_multistart_eval.py --area-m 500 --out results/sca_multistart_n20_500m.json
"""
